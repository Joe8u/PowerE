#!/usr/bin/env python3
# src/precompute/jasm/precompute_jasm_monthly.py

import calendar
import pandas as pd
from pathlib import Path
from src.loaders.jasm.jasm_loader import build_month_profile
...
def precompute_for_year(year: int, appliances=None):
    ...
    """
    out_dir = PROJECT_ROOT / "data" / "processed" / "static" / "jasm" / str(year) / "monthly"
